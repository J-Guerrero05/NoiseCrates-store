...
const SamplePackCard = ({ samplePack }: SamplePackCardProps) => {
  ...
  console.log("SamplePackCard - rendering pack:", samplePack.title, samplePack);
  ...
  return (
    <div className="card h-100 border-0 shadow-sm">
      <div className="position-relative">
        <img 
          src={samplePack.imageUrl || '/placeholder.svg'} 
          ...
          onError={(e) => {
            console.log("SamplePackCard - image failed to load:", samplePack.imageUrl);
            (e.target as HTMLImageElement).src = '/placeholder.svg';
          }}
        />
        <div className="position-absolute bottom-0 start-0 w-100 p-2">
          {samplePack.previewUrl && (
